...
neu build --release
# Move the Neutralino build artifacts to the unified build directory,
# creating the subdirectory structure that PyInstaller expects.
...
mkdir -p "../dist"
cp -r "$BUILD_DIR/dist/NIDRA/"* "../dist/"

info "Cleaning up build artifacts..."
# Clean up PyInstaller build artifacts
rm -rf "$BUILD_DIR/pyinstaller_build"

# Clean up Neutralino build artifacts
info "Cleaning up Neutralino build artifacts..."
...
#info "Removing Neutralino binaries..."
